                    ...
                    <div className="row">
                        <div className="col-sm-12">
                            <div className="col-sm-10 mx-auto text-center">
                                <div
                                    className="four_zero_four_bg bg-center h-96"
                                    style={{
                                ...
                                <div className="contant_box_404 ">
                                    ...
                                    <p className="my-8">The page you are looking for is not available!</p>

                                    <button onClick={goToHome} href="#" className="link_404 text-white bg-green-600 py-2 px-5 mt-5 inline-block">Go to Home</button>
                                </div>
                            </div>
                        </div>
                    </div>
