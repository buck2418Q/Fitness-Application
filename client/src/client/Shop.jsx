...
function Shop() {
 ...
 {product.price}</p>
            ...
            <div className="flex justify-between gap-2 w-full">
              <NextButton className="w-5/12 bg-light text-background border-background/30 border-1 dark:bg-secondary/90 dark:text-light dark:border-light/5">
                save
              </NextButton>
              <NextButton className="w-7/12">
                Add to Cart
              </NextButton>
            </div>
          </div>
